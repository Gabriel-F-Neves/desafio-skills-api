package br.com.residencia.api_desafio.security;
        ...
        if(authHeader != null && !authHeader.isBlank() && authHeader.startsWith("Bearer ")){
            ...
            if(jwt == null || jwt.isBlank()){
                ...
                try{
                    ...
                    String userLogin = jwtUtil.validateTokenAndRetrieveSubject(jwt);
                    ...
                    UsernamePasswordAuthenticationToken authToken =
                            new UsernamePasswordAuthenticationToken(userLogin, userDetails.getPassword(), userDetails.getAuthorities());
